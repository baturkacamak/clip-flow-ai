...
def test_effects_blur(mocker):
    ...
    mocker.patch("python_core.editing.effects.gaussian", return_value=np.zeros((100, 100, 3)))
    mocker.patch("python_core.editing.effects.resize", return_value=np.zeros((1920, 1080, 3)))
...
def test_compositor_render_call(mocker, mock_config_manager):
    # Mock MoviePy
    mocker.patch("python_core.editing.compositor.VideoFileClip")
    mocker.patch("python_core.editing.compositor.AudioFileClip")
    mocker.patch("python_core.editing.compositor.CompositeVideoClip")
    mocker.patch("python_core.editing.compositor.concatenate_videoclips")
